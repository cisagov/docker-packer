...
AWS_PROFILE=cool-images-ec2amicreate-docker-packer packer build --timestamp-ui -var release_tag=$(./bump-version show) -var is_prerelease=true .
```
...
```console
AWS_PROFILE=cool-images-ec2amicreate-docker-packer packer build --timestamp-ui -var-file release.pkrvars.hcl .
```
