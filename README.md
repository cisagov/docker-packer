...
secrets on the
[appropriate page](https://github.com/cisagov/docker-packer/settings/secrets)
...
[cool-images-ec2amicreate-docker-packer]
role_arn = arn:aws:iam::111111111111:role/EC2AMICreate-build-docker-packer
source_profile = build-docker-packer
...
AWS_PROFILE=cool-images-ec2amicreate-docker-packer packer build --timestamp-ui -var release_tag=$(./bump_version.sh show) -var is_prerelease=true src/packer.pkr.hcl
```
...
```console
AWS_PROFILE=cool-images-ec2amicreate-docker-packer packer build --timestamp-ui -var-file release.pkrvars.hcl src/packer.pkr.hcl
```
